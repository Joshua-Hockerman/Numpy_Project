...
print("The total sales were: ", salesArray.sum())
print()
...
# expensive = []
# flattened_array = salesArray.flatten()
# for i in range(len(flattened_array)):
#    if flattened_array[i] >= 100:
#        expensive = expensive + flattened_array[i]
...
print(salesArray)
salesArray[2, 3] = salesArray[2, 3] - 180
print(salesArray)
print()
